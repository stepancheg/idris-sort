...
data PermSimple : List a -> List a -> Type
    where
        ...
        PermSimpleIns : (p : PermSimple (xs ++ ys) (zs ++ ws)) -> (v : a) ->
...
permSimpleSym (PermSimpleIns p v) = PermSimpleIns (permSimpleSym p) v
